...
CALCULATOR_ROUTES.forEach((route) =>
  addName(route.path, route.name),
);
...
const getPrimaryTopic = (route, type) => {
  if (type === "Service" || type === "Maintenance") return nameByRoute.get(route) || "Service";
...
const getOutLinks = (route, type) => {
  switch (type) {
    case "Home":
      return dedupe([...maintenanceLinks, ...servicePillars, TOOLS_HUB_LINK.to, ...geoLinks]).slice(0, 8);
    case "Tools Hub":
      return dedupe([ ...topTools, ...maintenanceLinks, SERVICE_PILLAR_LINKS.inspection.to, ...geoLinks, "/contact"]).slice(0, 8);
    case "Tool":
      return dedupe([
        ...maintenanceLinks,
...
const getInboundSources = (type) => {
  switch (type) {
    case "Home":
      return ["/services", "/resources", "/maintenance-plans", "/commercial-maintenance", "/service-areas"];
    case "Tools Hub":
      return ["/", "/maintenance-plans", "/commercial-maintenance", "/resources", "/services"];
    case "Tool":
      return [TOOLS_HUB_LINK.to, "/maintenance-plans", "/commercial-maintenance", "/resources", "/services"];
    case "Maintenance":
      return ["/", TOOLS_HUB_LINK.to, "/services", "/resources", "/service-areas"];
    case "Service":
      return ["/services", "/maintenance-plans", "/commercial-maintenance", TOOLS_HUB_LINK.to, "/service-areas"];
    case "Guide":
      return ["/resources", TOOLS_HUB_LINK.to, "/maintenance-plans", "/services", "/blog"];
    case "Location Hub":
      return ["/", "/services", "/maintenance-plans", "/commercial-maintenance", TOOLS_HUB_LINK.to];
    case "Landing":
      return ["/", "/services", "/maintenance-plans", "/commercial-maintenance", "/contact"];
    case "Blog Hub":
    case "Blog Post":
      return ["/blog", "/services", "/resources", "/maintenance-plans", TOOLS_HUB_LINK.to];
    default:
