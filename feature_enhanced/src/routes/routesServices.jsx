...
export const serviceRoutes = [
  ...
  { path: "/commercial/preventive-maintenance", element: <PreventiveMaintenance /> },
  { path: "/commercial/emergency-repairs", element: <EmergencyRepairs /> },
  { path: "/commercial/ada-compliance", element: <ADACompliance /> },
  { path: "/commercial-service-agreements", element: <CommercialServiceAgreements /> },
  { path: "/services/water-damage-mitigation", element: <Navigate to="/water-damage-restoration" replace /> },
  { path: "/services/mold-remediation", element: <Navigate to="/mold-remediation" replace /> },
  { path: "/services/fire-smoke-damage", element: <Navigate to="/fire-smoke-damage" replace /> },
  { path: "/services/bathroom-remodels", element: <Navigate to="/bathroom-remodels" replace /> },
  { path: "/services/kitchen-remodels", element: <Navigate to="/kitchen-remodels" replace /> },
  { path: "/services/general-contracting", element: <Navigate to="/inspection-repairs" replace /> },
  { path: "/services/residential-maintenance", element: <Navigate to="/maintenance-plans" replace /> },
  { path: "/services/moisture-envelope", element: <Navigate to="/moisture-control" replace /> },
  { path: "/services/aging-in-place", element: <Navigate to="/accessibility-retrofits" replace /> },
  { path: "/services/insurance-adjacent", element: <Navigate to="/insurance-claims-repairs" replace /> },
  { path: "/services/energy-comfort", element: <Navigate to="/energy-comfort-retrofits" replace /> },
  { path: "/services/commercial", element: <Navigate to="/commercial-maintenance" replace /> },
  { path: "/services/commercial/tenant-turns", element: <Navigate to="/commercial/tenant-turns" replace /> },
  { path: "/services/commercial/preventive-maintenance", element: <Navigate to="/commercial/preventive-maintenance" replace /> },
  { path: "/services/commercial/emergency-repairs", element: <Navigate to="/commercial/emergency-repairs" replace /> },
  { path: "/services/commercial/ada-compliance", element: <Navigate to="/commercial/ada-compliance" replace /> },
  { path: "/services/commercial/service-agreements", element: <Navigate to="/commercial-service-agreements" replace /> },
];
