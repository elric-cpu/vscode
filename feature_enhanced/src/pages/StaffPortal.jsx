      ...
      <div className="min-h-screen bg-cream-50 py-10">
        <div className="max-w-6xl mx-auto px-4 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold text-contractor-black">Estimating Workspace</h1>
              <p className="text-gray-600">Upload inspection reports, review AI-drafted scopes, and finalize pricing.</p>
            </div>
            {orgOptions.length > 1 && (
              ...
              {selectedProject ? (
                <>
                  <DocumentUploader
                    ...
                    onStatusUpdate={(data) => setStatus({ ...data, document_id: data?.document_id })}
                  />

                  <ExtractionStatus status={status} onRefresh={refreshStatus} />

                  {loading && (
                    <div className="text-sm text-gray-500">Loading estimate…</div>
                  )}
