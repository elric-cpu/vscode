  ...
  const handleSubmit = async (e) => {
    ...
    if (!result.success) {
      ...
      if (userId) {
        ...
        const missing = !profile?.company_name || !profile?.phone || !profile?.address;
        if (missing) {
    ...
    <div className="min-h-screen bg-[#EFE3C8] flex items-center justify-center px-4 py-12">
      ...
      >
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="email" className="text-[#2A2A2A] font-semibold">Email Address</Label>
                <Input
                  id="email"
                  type="email"
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Link to="/client-portal-forgot-password" className="text-xs text-[#3C0008] hover:underline font-semibold">Forgot password?</Link>
                </div>
                <Input
                  id="password"
                  type="password"
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="grid grid-cols-1 gap-2">
                ...
                <Button type="button" variant="outline" onClick={() => handleOAuth("azure")}>
        ...
        <div className="text-center mt-6">
          <Link to="/" className="text-[#3C0008] text-sm font-semibold hover:underline flex items-center justify-center gap-1">
