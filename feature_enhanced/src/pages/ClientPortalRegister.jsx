      ...
      <main className="min-h-screen bg-[#FAF6EE] py-20 px-4">
        <div className="max-w-lg mx-auto bg-white border border-[#D4C5A5] p-8">
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            <div>
              <label className="block text-sm font-medium text-charcoal-text mb-1" htmlFor="name">
                Full Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label className="block text-sm font-medium text-charcoal-text mb-1" htmlFor="email">
                Email Address
              </label>
              <input
                id="email"
            ...
            <div>
              <label className="block text-sm font-medium text-charcoal-text mb-1" htmlFor="password">
                Password
              </label>
              <input
                id="password"
            ...
            <div>
              <label className="block text-sm font-medium text-charcoal-text mb-1" htmlFor="confirmPassword">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
          ...
          <div className="mt-6 text-sm text-[#4A4A4A]">
            <p>
              ...
              <Link to="/subcontractor-portal-register" className="text-[#3C0008] font-bold hover:underline">
                Register here
              </Link>
            </p>
          </div>
