    ...
    >
      <div className="bg-cream border border-gray-200 rounded-xl p-6">
        ...
        <p className="text-xs text-gray-500 mt-3 mb-0">
          ZIP-adjusted labor rate: {formatCurrency(results.rate)} / hr · {localization.regionLabel}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-xs text-gray-500 m-0">Saved hours: {formatNumber(results.savedHours, 0)}</p>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
        ...
        <p className="text-sm text-restoration-gray mb-3">
          A property manager cut work order time by 22% after implementing digital
          routing and bundled preventive visits.
        </p>
