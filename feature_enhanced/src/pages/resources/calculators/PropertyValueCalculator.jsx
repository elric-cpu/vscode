    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-xs text-gray-500 m-0">
            Payback: {results.payback ? `${formatNumber(results.payback, 1)} yrs` : "N/A"}
          </p>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
        ...
        <p className="text-sm text-restoration-gray mb-3">
          A fourplex completed paint and flooring upgrades. Rents increased by $95
          per unit within 60 days.
        </p>
        <p className="text-xs text-gray-500 m-0">
