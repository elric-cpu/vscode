...
const PreventiveMaintenanceROICalculator = () => {
  ...
  const results = useMemo(() => {
    ...
    const paybackMonths =
      savings > 0 ? preventive / (savings / 12) : null;
  ...
  }, [preventiveCost, incidents, avgEmergency, complianceRisk, localization.costFactor]);
  ...
  const faqs = [
    ...
    {
      question: "Is the ROI calculation the same for residential and commercial?",
      answer:
  ...
  return (
    ...
    >
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
          ...
          <div>
            ...
            <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
              <div
                ...
                style={{ width: `${Math.min(results.comparisonRatio / 3, 1) * 100}%` }}
              />
            </div>
          </div>
          <div>
        ...
        <p className="text-xs text-gray-500 mt-3 mb-0">
          Payback: {results.paybackMonths ? `${formatNumber(results.paybackMonths, 1)} months` : "No payback yet"}
        </p>
      </div>
