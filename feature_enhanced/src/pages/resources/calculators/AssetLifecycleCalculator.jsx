...
const AssetLifecycleCalculator = () => {
  ...
  useEffect(() => {
    ...
    setAnnualPmSpend(Math.round(model.baseReplacement * model.recommendedPmRate));
  }, [model]);

  const results = useMemo(() => {
    const replacement = toNumber(replacementCost, model.baseReplacement) *
  ...
  return (
    ...
    >
      ...
      <ResultsLock locked={!submitted} message="Detailed lifecycle report locked">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
        ...
        <p className="text-sm text-restoration-gray mb-3">
          ...
          replacement was delayed by 4.5 years.
        </p>
        <p className="text-xs text-gray-500 m-0">
