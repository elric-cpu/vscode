...
const MaterialsEstimatorCalculator = () => {
  ...
  const results = useMemo(() => {
    const area = toNumber(squareFeet, 0) * (1 + toNumber(wastePercent, 0) / 100);
    const costPerUnit = model.costPerUnit[quality] || model.costPerUnit.standard;
    let quantity = 0;
  ...
  }, [squareFeet, wastePercent, quality, projectType, localization.costFactor, model]);
    ...
    >
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
        ...
        <p className="text-sm text-restoration-gray mb-3">
          A 1,100 sq ft rental used the estimator to plan paint + flooring. The project
          finished on time with 8% unused materials.
        </p>
        <p className="text-xs text-gray-500 m-0">
