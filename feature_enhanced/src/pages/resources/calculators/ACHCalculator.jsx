    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-xs text-gray-500 m-0">
            Status: {status === "within" ? "On target" : status === "below" ? "Below target" : "Above target"}
          </p>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
        ...
        <p className="text-sm text-restoration-gray mb-3">
          A 1,800 sq ft clinic increased ACH from 3.2 to 6.8 using dedicated outdoor
          air and upgraded filtration.
        </p>
        <p className="text-xs text-gray-500 m-0">
