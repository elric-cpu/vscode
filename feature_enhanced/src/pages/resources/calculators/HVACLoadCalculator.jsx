    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-xs text-gray-500 m-0">
            {localization.regionLabel} · Factor {localization.costFactor.toFixed(3)}x
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-restoration-gray">
            <div>
              ...
              <ul className="space-y-1">
                <li>
                  Ceiling factor: {formatPercent((heightValue / 8) * 100 - 100, 0)} adjustment
                </li>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
        ...
        <p className="text-sm text-restoration-gray mb-3">
          A 4,800 sq ft clinic in ZIP 97386 replaced an oversized unit. Right-sizing
          reduced energy use by 18% and cut summer comfort complaints by half.
        </p>
        <p className="text-xs text-gray-500 m-0">
