  ...
  return (
    ...
    >
      <div className="prose prose-lg max-w-none text-gray-700">
        <p>
          An annual maintenance budget keeps small issues from becoming expensive
          repairs. Start with a realistic baseline, then allocate additional
          reserves for older systems or homes with deferred upkeep.
        </p>
        <p>
        ...
        <p>
          ...
          intrusion or correct code issues should come first. That includes
          leak tracing and{" "}
          <Link
