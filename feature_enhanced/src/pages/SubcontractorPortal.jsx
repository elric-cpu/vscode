      ...
      <div className="min-h-screen bg-cream-button py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-10 text-center">
             <h2 className="text-xl font-bold tracking-wide text-charcoal-text">BENSON ENTERPRISES</h2>
             <p className="text-sm text-gray-500">Partner Portal Access</p>
          </div>

          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
              <h1 className="text-3xl font-bold text-charcoal-text">Subcontractor Portal</h1>
              <p className="text-[#4A4A4A]">Manage work orders, submit reports, and track performance.</p>
            </div>
            {!hasOnboarded && (
              <Button 
            ...
            <Tabs defaultValue="orders" className="w-full">
               ...
               <div className="border-b border-gray-200 px-6 py-4 bg-cream-button">
                <TabsList className="bg-white border border-gray-200">
                  <TabsTrigger value="orders" className="text-charcoal-text data-[state=active]:bg-charcoal-text data-[state=active]:text-cream-button">Work Orders</TabsTrigger>
                  <TabsTrigger value="upload" className="text-charcoal-text data-[state=active]:bg-charcoal-text data-[state=active]:text-cream-button">Upload & Reporting</TabsTrigger>
                  <TabsTrigger value="performance" className="text-charcoal-text data-[state=active]:bg-charcoal-text data-[state=active]:text-cream-button">Performance</TabsTrigger>
                </TabsList>
              </div>
              ...
              <TabsContent value="upload" className="p-6 bg-white">
                <div className="max-w-2xl mx-auto">
                  ...
                  <div className="bg-cream-button border border-gray-200 rounded-lg p-8">
                    <h3 className="text-xl font-bold text-charcoal-text mb-6">Submit Work Report</h3>
                     {/* Simplified for brevity - reuse from previous task logic if needed */}
                     <p className="text-[#4A4A4A] italic text-center">Please complete onboarding to access reporting tools.</p>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="performance" className="p-6 bg-white">
                <div className="max-w-4xl mx-auto text-center py-12">
                   ...
                   <p className="text-[#4A4A4A]">Performance data unavailable until first job completion.</p>
                </div>
              </TabsContent>
            </Tabs>
          </div>
