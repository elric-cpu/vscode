...
const FireSmokeDamage = () => {
  ...
  const nextSteps = [
    ...
    },
    {
      ...
      to: "/contact",
      description: "Documented scope, cleanup coordination, and repair planning.",
      intent: "contact",
      cta: "Request service",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="bg-cream border border-cream rounded-xl p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link to={MAINTENANCE_LINKS.home.to} className="text-maroon font-semibold">
      ...
      <section className="py-16 bg-cream">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[SERVICE_PILLAR_LINKS.water, SERVICE_PILLAR_LINKS.mold, SERVICE_PILLAR_LINKS.inspection].map(
              (link) => (
                <Link
                  key={link.to}
                  to={link.to}
