...
const HinesOR = () => {
  ...
  const faqs = [
    {
      ...
      answer:
        "We serve Hines with the same priority as Burns—typically within a few hours for emergency water damage situations. We're local to Harney County and committed to fast response.",
    },
    {
      question: "Do you provide free estimates in Hines?",
      answer:
        "Yes. We offer free, no-obligation estimates for all services throughout Hines and the surrounding area.",
    },
    {
      question: "Are you licensed to work in Hines, Oregon?",
      answer:
        "Absolutely. Oregon CCB# 258533 covers all our work statewide, including Hines and Harney County. We're fully licensed, bonded, and insured.",
    },
    {
      question:
        "Can you help coordinate insurance claims for Hines homeowners?",
      answer:
        "Yes. We work directly with insurance companies, provide detailed documentation, and help streamline the claims process for water damage, mold remediation, and restoration projects.",
    },
    {
      question: "What sets you apart from other contractors serving Hines?",
      answer:
        "We're local, professional, and dedicated to quality work. Licensed contractor, clear communication, and we treat every home with care and respect.",
    },
    {
      question: "Do you serve rural areas around Hines?",
      answer:
        "Yes. We serve Hines, Burns, and the surrounding rural Harney County areas. Contact us to confirm service availability for your specific location.",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>
          Hines OR Construction & Restoration | Water Damage, Remodels - Benson
          Home Solutions
        </title>
        <meta
          name="description"
          content="Professional contractor serving Hines, Oregon. Water damage mitigation, mold remediation, kitchen & bathroom remodels. Licensed CCB# 258533. Call (541) 321-5115."
        />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-cream mb-6">
              Licensed contractor providing water damage mitigation, mold
              remediation, and home remodeling services for Hines and Harney
              County.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-restoration-gray mb-6">
            Benson Home Solutions serves Hines with the same professional
            construction and restoration services we provide throughout Harney
            County. From emergency water damage response to planned home
            remodels, our licensed team delivers quality workmanship and
            reliable service.
          </p>
          <p className="text-lg text-restoration-gray">
            Hines homeowners appreciate our straightforward approach—clear
            communication, transparent pricing, and respect for your property.
            Whether you need emergency mitigation or are planning a kitchen
            renovation, we bring professionalism to every project.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-bold text-contractor-black mb-3">
                Local Harney County Contractor
              </h3>
              <p className="text-restoration-gray">
                We understand Eastern Oregon construction challenges and bring
                local knowledge combined with professional standards to every
                project in Hines.
              </p>
            </div>
            <div>
              ...
              <p className="text-restoration-gray">
                Water damage requires immediate action. We offer 24/7 emergency
                mitigation services for Hines residents to minimize damage and
                protect your property.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-bold text-contractor-black mb-3">
                Quality Workmanship & Clear Communication
              </h3>
              <p className="text-restoration-gray">
                From the initial estimate through project completion, we keep
                you informed and deliver work that meets professional standards.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-bold text-contractor-black mb-3">
              ...
              <p className="text-restoration-gray">
                CCB# 258533. All work is performed by licensed, insured
                professionals who follow Oregon building codes and industry best
                practices.
              </p>
            </div>
          </div>
