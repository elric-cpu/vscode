...
const SweetHomeOR = () => {
  const services = [
    {
      ...
      description:
        "Emergency water extraction and drying for Sweet Home homeowners.",
    ...
    },
    {
      ...
      description:
        "Complete bathroom renovations throughout Sweet Home and Linn County.",
    ...
    },
    {
      ...
      description:
        "Home additions, repairs, and renovations in Sweet Home, OR.",
  ...
  const faqs = [
    {
      ...
      answer:
        "Yes. We respond quickly to water damage emergencies in Sweet Home and throughout the Mid-Willamette Valley. Call us immediately when water damage occurs.",
    },
    {
      question: "Are you licensed to work in Sweet Home and Linn County?",
      answer:
        "Absolutely. Oregon CCB# 258533 covers all our work statewide. We're fully licensed, bonded, and insured for projects in Sweet Home and throughout Oregon.",
    },
    {
      question: "Do you offer free estimates in Sweet Home?",
      answer:
        "Yes. We provide free, no-obligation estimates for all services in Sweet Home and surrounding Mid-Valley areas.",
    },
    {
      question: "Can you help with insurance claims for Sweet Home residents?",
      answer:
        "Definitely. We have extensive experience working with insurance companies on behalf of Sweet Home homeowners. We document damage, provide detailed estimates, and coordinate with adjusters.",
    },
    {
      question: "How far beyond Sweet Home do you travel?",
      answer:
        "We serve Sweet Home, Lebanon, Albany, and surrounding Mid-Valley communities. Contact us to confirm service availability for your specific location.",
    },
    {
      question:
        "What makes you different from other contractors in the Sweet Home area?",
      answer:
        "We're licensed (CCB# 258533), experienced in both emergency restoration and planned remodels, and committed to clear communication and quality work. Professional service, local presence.",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>
          Sweet Home OR Construction & Restoration | Remodels, Water Damage -
          Benson Home Solutions
        </title>
        <meta
          name="description"
          content="Licensed contractor serving Sweet Home, Oregon. Water damage mitigation, mold remediation, kitchen & bathroom remodels. CCB# 258533. Call (541) 321-5115."
        />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-cream mb-6">
              ...
              remodeling services for Sweet Home and the Mid-Valley.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-restoration-gray mb-6">
            ...
            restoration services to Sweet Home and the Mid-Willamette Valley.
            Whether you're dealing with water damage, planning a bathroom
            remodel, or need general contracting services, we deliver quality
            workmanship and reliable communication.
          </p>
          <p className="text-lg text-restoration-gray">
            Sweet Home homeowners choose us for our professional approach,
            transparent pricing, and commitment to doing the job right. We
            understand the unique needs of Mid-Valley homes and bring the
            expertise to handle everything from emergency situations to complete
            renovations.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-bold text-contractor-black mb-3">
                Mid-Valley Expertise
              </h3>
              <p className="text-restoration-gray">
                We understand the construction and restoration needs specific to
                the Mid-Willamette Valley. Professional service with local
                accessibility.
              </p>
            </div>
            <div>
              ...
              <p className="text-restoration-gray">
                Water damage requires immediate action. We prioritize emergency
                calls from Sweet Home residents to minimize damage and protect
                your property and insurance claim.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-bold text-contractor-black mb-3">
              ...
              <p className="text-restoration-gray">
                From estimate through completion, we keep you informed. You'll
                know what to expect at each stage—no surprises, just
            ...
            <div>
              ...
              <p className="text-restoration-gray">
                Oregon CCB# 258533. Fully licensed, bonded, and insured. All
                work meets Oregon building codes and industry standards.
              </p>
            </div>
          </div>
        </div>
