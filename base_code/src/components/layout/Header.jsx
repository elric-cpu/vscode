      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="flex items-center gap-3">
            <img src="https://horizons-cdn.hostinger.com/ae3477ac-6bf1-4f8b-8f34-eb7eaf405699/25b40853ea3bb45850a91acd0a670aaf.png" alt="Benson Home Solutions logo" className="h-12 w-auto" />
